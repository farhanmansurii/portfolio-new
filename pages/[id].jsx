    ...
    <div className="mx-auto w-11/12 ">
      <div className="flex flex-col lg:flex-row gap-5  ">
        ...
        <div className="text-inherit text-md lg:text-xl lg:my-6 lg:w-8/12">
          ...
          <div className="text-white/70">{data.description}</div>
          <div className="flex justify-between  lg:flex my-10">
            ...
            <div className="bg-white py-2 px-4 hover:scale-95 duration-150"><a href={data.github}>
              Visit Github</a></div>
          </div>{' '}
          <div>
            <div className="text-white border-b-[1px] my-2  text-3xl border-gray-500 w-full ">TECH STACK</div>
            {data.techStack.map((e, i) => (
              <div key={i} className="text-white border-b-[1px] my-4 border-gray-500 w-full ">
                {e}
              </div>
            ))}
          </div>
