...
const handleClick = () => {
  ...
  return (
    <div onScroll={handleScroll}>
      <div className=" h-100vh  bg-[#bebebe] text-4xl lg:text-6xl py-4 w-11/12 mx-auto">
      ...
      <div className="flex w-11/12 mx-auto mt-[5rem] ">
        <div className="w-fit text-[#bebebe] lg:text-3xl  py-4  mx-auto">About me</div>
        <div className="h-100vh  bg-[#bebebe] lg:text-3xl px-6 py-4 w-11/12 mx-auto">
