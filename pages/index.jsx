...
export default function Home() {
  ...
  return (
    <div onScroll={handleScroll}>
      ...
      <button className='fixed bottom-0 right-0 mb-5 mr-5 bg-[#262525] rounded-full border-2 border-[#bebebe] px-4 py-2  text-[#bebebe]'  onClick={handleClick}>Back to top</button>
    </div>
  );
}
